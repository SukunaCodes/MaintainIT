...
<html lang="en">
  <head>
    ...
    <title>MaintainIT: Web Based Scheduling App</title>
  ...
  <body>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-7 col-sm-9 col-11 mx-auto">
          <div class="grid shadow">
            <p class="grid-header">First Account (ADMIN-> Default)</p>
            <div class="grid-body">
    ...
    <div class="error_page error_2">
      <div class="container inner-wrapper">
        <h1 class="display-1 error-heading">Greetings!</h1>
        <h2 class="error-code">Login first</h2>
